...
var wordList = [
    ...
    // スポーツ
    "golf","soccer","judo","swimming","ski","tennis","basketball","baseball",
    // 国
    "Italy","Spain","Germany","France","Portugal","China","Japan","Australia","Argentina","Cuba","Brazil","USA"
];
...
document.onkeydown = function (e) {
    ...
    if (wordChars[charIndex] == keyStr) {
        ...
        if (charIndex == wordChars.length) {
            ...
            if(score >= 20){    // 20問でクリア
                stopTyping();
                swal("Good job!","20問正解!クリア!","success");
            }else{
                nextWord();     //次の単語へ
            }
        }
